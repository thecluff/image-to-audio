...
#   Split source.png RGB channels into three separate images
magick source.png -channel-fx "red; green; blue" ./temp/output.png

#   Convert the images into three audio files
python3 spectrographic.py --image ./temp/output-0.png --min_freq 300 --max_freq 1000 --duration 5 --resolution 255 --save ./temp/sound1.wav 

python3 spectrographic.py --image ./temp/output-1.png --min_freq 375 --max_freq 1200 --duration 5 --resolution 319 --save ./temp/sound2.wav 

python3 spectrographic.py --image ./temp/output-2.png --min_freq 450 --max_freq 1500 --duration 5 --resolution 383 --save ./temp/sound3.wav
